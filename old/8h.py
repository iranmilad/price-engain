...
def stockprice(bars,symbol):
    ...
    r = redis.Redis(host='149.28.120.38', port=6379,password='6$gtA453', db=9)
...
for symbol in claster:
    ...
    bars = ib.reqHistoricalData(
        ...
        barSizeSetting='8 hours', whatToShow=candelShow, useRTH=True)
