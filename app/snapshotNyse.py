...
class PriceSeries:
    ...
    def stockprice(self,bars,years,symbol):
        ...
        if len(years)==0 or len(bars)==0:
            ...
            self.append_new_line('snapshotNyse.txt', symbol)
        else:
    ...
    def update_bar(self):
        ...
        exist_nyse_symbol= list(set(clasters).intersection(set(self.primary_nyse)) )
        for i in range(0,len(exist_nyse_symbol),850):
            claster = exist_nyse_symbol[i:i + 850]
            ...
            if claster:
                ...
                contracts=self.getContractNyse(claster)
                self.threads=[]
