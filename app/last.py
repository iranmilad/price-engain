...
def stockprice(bars,symbol):
    ...
    r = redis.Redis(host='149.28.120.38', port=6379,password='6$gtA453', db=13)
...
ib = IB()
client=63
ib.connect('127.0.0.1', 7497, clientId=client,timeout=client)
claster_sharkscreen=['SPY','ECL','LYB','NEM','DIS','EA','FB','GOOG','MTCH','NFLX','PINS','ROKU','TWLO','Z','QCOM','SNOW','SQ','TTD','VMW','WDAY','ZS','ZEN','SPOT','VEEV','BBY','CHWY','CVNA','DRI','ETSY','HD','LEN','LOW','MAR','MCD','NKE','PTON','RCL','AEP','D','DUK','ED','ES','LNT','CMS','BABA','NOW','CL','COST','CLX','DG','DLTR','PG','STZ','TSN','WMT','TSLA','CVX','COF','GS','ICE','MMC','PYPL','STT','V','ABBV','ANTM','BIIB','EW','BA','CAT','CPRT','FDX','GPN','LHX','LMT','UNP','WM','DLR','PLD','SPG','AAPL','ADBE','ADI','AMD','AMAT','AVGO','COUP','CRM','CRWD','CTSH','CTXS','DOCU','ENPH','FIS','KLAC','LRCX','MCHP','MSFT','MU','NOW','NVDA','OKTA']

claster=getSymbols('1d')
claster=claster+claster_sharkscreen
...
while True:
    ...
    if 60-int(time.time() - start_time)>0:
