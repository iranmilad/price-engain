...
def stockprice(bars,symbol):
    ...
    r = redis.Redis(host='149.28.120.38', port=6379,password='6$gtA453', db=7)
...
for symbol in claster:
    ...
    bars = ib.reqHistoricalData(
        contract, endDateTime='', durationStr='17 D',
        barSizeSetting='2 hours', whatToShow=candelShow, useRTH=True)
