...
def stockprice(bars,symbol):
    ...
    r = redis.Redis(host='149.28.120.38', port=6379,password='6$gtA453', db=3)
...
for symbol in claster:
    ...
    bars = ib.reqHistoricalData(
        ...
        barSizeSetting='10 mins', whatToShow=candelShow, useRTH=True)
...
while True:
    ...
    if 600-int(time.time() - start_time)>0:
        time.sleep(600-int(time.time() - start_time))
ib.disconnect()
