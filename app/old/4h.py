...
def stockprice(bars,symbol):
    ...
    r = redis.Redis(host='149.28.120.38', port=6379,password='6$gtA453', db=8)
...
for symbol in claster:
    ...
    bars = ib.reqHistoricalData(
        contract, endDateTime='', durationStr='34 D',
        barSizeSetting='4 hours', whatToShow=candelShow, useRTH=True)
